...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-m0lynq");
    			add_location(img, file$3, 5, 2, 54);
    			attr_dev(header, "class", "svelte-m0lynq");
    			add_location(header, file$3, 4, 0, 43);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			i1 = element("i");
    			attr_dev(i0, "class", "fa fa-download icons svelte-ltzdte");
    			add_location(i0, file$2, 9, 2, 201);
    			attr_dev(i1, "class", "fa fa-plus icons svelte-ltzdte");
    			add_location(i1, file$2, 10, 2, 262);
    			attr_dev(div, "class", "side-bar svelte-ltzdte");
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const downloadCode = () => {
    		downloadCodeFromEditor("document.txt");
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "id", "text-editor");
    			attr_dev(div, "class", "svelte-waj8ps");
    			add_location(div, file$1, 9, 0, 175);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	header = new Header({
    			props: { imageSrc: "images/LogoMakr-38S17p.png" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "wrapper svelte-1vo6g33");
    			add_location(div, file, 9, 0, 269);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, SideNav, CodeEditor, onMount });
    	return [];
    }
